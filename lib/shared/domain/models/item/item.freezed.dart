...
class _$ItemImpl implements _Item {
  ...
  @override
  String toString() {
    return 'Item(id: $id, itemCategoryId: $itemCategoryId, name: $name, description: $description, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, itemCategoryId, name, description, createdAt, updatedAt);
