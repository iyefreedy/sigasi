...
class _$VillageImpl implements _Village {
  ...
  @override
  String toString() {
    return 'Village(id: $id, districtId: $districtId, name: $name, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, districtId, name, createdAt, updatedAt);
...
abstract class _Village implements Village {
  const factory _Village(
      ...
      required final DateTime updatedAt}) = _$VillageImpl;
