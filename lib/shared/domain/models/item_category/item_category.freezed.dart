...
class _$ItemCategoryImpl implements _ItemCategory {
  ...
  @override
  String toString() {
    return 'ItemCategory(id: $id, name: $name, description: $description, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
...
abstract class _ItemCategory implements ItemCategory {
  const factory _ItemCategory(
      ...
      required final DateTime updatedAt}) = _$ItemCategoryImpl;
